...
import { View, Text, StyleSheet, FlatList, Pressable, ActivityIndicator, useColorScheme, Image } from 'react-native';
  ...
  const renderItem = ({ item }: { item: Manga }) => (
    ...
    >
      ...
      <View style={styles.itemInfo}>
        ...
        <Text style={[styles.details, { color: theme.icon }]}>{item.status} • {item.year}</Text>
  ...
  return (
    <View style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <View style={[styles.header, { backgroundColor: theme.surface, borderBottomColor: theme.border }]}>
        ...
        <Text style={[styles.headerTitle, { color: theme.text }]}>Manga Management</Text>
        <Pressable onPress={() => router.push('/(admin)/admin-manga/new' as any)} style={styles.addButton}>
